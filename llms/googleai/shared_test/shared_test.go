...
import (
	...
	"github.com/linhaojun857/langchaingo/llms/googleai"
	"github.com/linhaojun857/langchaingo/llms/googleai/vertex"
...
func testMultiContentImageLink(t *testing.T, llm llms.Model) {
	...
	parts := []llms.ContentPart{
		llms.ImageURLPart(
			"https://github.com/linhaojun857/langchaingo/blob/main/docs/static/img/parrot-icon.png?raw=true",
		),
